...
SCT:
- **5.2: Estimação de máxima verosimilhança** - Dado um parâmetro `\theta` e observações ruidosas do parâmetro (`z`), a estimativa do parâmetro (`\theta_til`) obtém-se usando um *estimador*.
